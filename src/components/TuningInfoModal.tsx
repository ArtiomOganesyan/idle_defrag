...
export const TuningInfoModal: React.FC<TuningInfoModalProps> = ({
  ...
  const cardDetails = [
    ...
    },
    {
      ...
      maxLevelText: 'LVL 0 - 10 (0% to 10% Glitch)',
      color: '#f43f5e',
      border: 'rgba(244, 63, 94, 0.3)',
      bg: 'rgba(136, 19, 55, 0.2)',
      description:
        'Induces sector entropy, parity errors, and bit-rot across the cluster map. The more it is upgraded (0 to 10), the more corrupted data blocks appear on disk. Corrupted sectors pulse red and provide a +50% point bonus when repaired.',
      formula: 'Corruption Severity = Level 0 (Off) to Level 10 (higher glitch probability per cycle). Repaired bad sectors grant +50% bonus points.',
    },
    {
      id: 'autoFrag',
      tag: 'WRITE I/O',
